  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">        
        ...
        <h3 className="text-2xl md:text-4xl font-joyful text-gray-900 mb-4 group-hover:text-blue-600 transition-colors">
          {event.title}
        </h3>
        
        <p className=" font-joyful text-gray-600 text-lg leading-relaxed mb-8">
          {event.description}
        </p>
