      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-helvetica text-2xl font-bold text-black group-hover:underline underline-offset-4 decoration-1">
              {title}
            </h3>
          </div>
        ...
        {description && (
          <p className="font-helvetica text-zinc-600 text-m leading-relaxed whitespace-pre-line">
            {description}
          </p>
        )}
      </div>
