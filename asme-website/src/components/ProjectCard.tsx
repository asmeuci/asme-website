  ...
  const cardContent = (
    <>
      ...
      <div className="flex-1 px-8 pb-8 pt-2 flex flex-col">        
        <h3 className="font-joyful text-4xl text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">
            {event.title}
        </h3>
        <p className="font-joyful text-gray-600 text-base leading-relaxed mb-6">
          {event.description}
        </p>

        <div className="mt-auto pt-4 border-t border-gray-100">
            <span className="text-black text-sm font-joyful hover:text-blue-600 transition-colors flex items-center gap-2">
            View Project
